...
urlpatterns = [
    ...
    path('registration/', views.CustomerRegistrationView.as_view(), name='customer_register'),
    ...
    path('rest/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name = "password_reset_confirm.html", form_class = MySetPasswordForm), name= 'password_reset_confirm'),
